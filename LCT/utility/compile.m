...
src = 'C:\Users\zhxing\Desktop\论文代码\lct-tracker-master\utility\im2colstep.c';
cmd = sprintf('mex %s %s', mex_flags, src);
if opts.verbose > 0, disp(cmd); end
if ~opts.dryrun, eval(cmd); end

% Compile MxArray and BMS
src = 'C:\Users\zhxing\Desktop\论文代码\lct-tracker-master\utility\MxArray.cpp';
   
cmd = sprintf('mex %s -c %s', mex_flags, src);
if opts.verbose > 0, disp(cmd); end
if ~opts.dryrun, eval(cmd); end

src = {'C:\Users\zhxing\Desktop\论文代码\lct-tracker-master\utility\calcIIF.cpp'};
